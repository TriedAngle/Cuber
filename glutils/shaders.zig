...
pub const Program = struct {
    ...
    pub fn uniform(self: *Self, name: [*c]const u8, comptime T: type, value: T) void {
        ...
        switch (T) {
            ...
            [3]u32 => gl.programUniform3ui(self.handle, location, value[0], value[1], value[2]),
            [3]i32 => gl.programUniform3i(self.handle, location, value[0], value[1], value[2]),
            [3]f32 => gl.programUniform3f(self.handle, location, value[0], value[1], value[2]),
